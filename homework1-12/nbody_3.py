"""
    N-body simulation.
    In this version, I subtitute global variables with local variables
    that is, instead of calling BODIES.keys() every time in the for loop
    It ranked second among four versions. R = 1.0869493157967316
"""
...
def advance(dt):
    ...
    Local_keys = BODIES.keys()
    seenit = []
    for body1 in Local_keys:
        for body2 in Local_keys:
...
def nbody3(loops, reference, iterations):
    '''
        nbody simulation
