"""
    N-body simulation.
    In this version, I modified the nested for loop to one for loop using itertools and create key pairs.
    It ranked the third in four version. R = 1.0410192301632775
"""
...
def advance(dt):
    ...
    # import itertools module and create keys pairs
    import itertools as it
    pairs = it.combinations(BODIES.keys(), 2)
    for pair in pairs:
        ((x1, y1, z1), v1, m1) = BODIES[pair[0]]
        ((x2, y2, z2), v2, m2) = BODIES[pair[1]]
...
def nbody4(loops, reference, iterations):
    '''
        nbody simulation
